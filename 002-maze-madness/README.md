...
| 3 | AND / OR 조건 / AND / OR | 갈림길 풀이 / Solve forks | *준비 중* |
| 4 | 미니 큐브 미로 연습 / Mini Cube Maze | 작은 큐브 미로 풀이 / Small cube solver | *준비 중* |
...
>
> 💡 3-4주도 같은 월드 파일(`week3-4.mcworld`)을 사용할 예정입니다 (현재 준비 중).
> Weeks 3-4 will share the same world file (`week3-4.mcworld`) — coming soon.
