# ⚡ WD002 — 웹 개발 기초: JavaScript

**영어코딩**의 8주 웹 개발 코스입니다. 정적인 HTML 페이지에서 출발해 버튼·입력·조건·배열을 거쳐, 마지막에는 자기만의 **대화형 퀴즈 앱**을 직접 완성합니다. 매주 한 가지 핵심 개념에 집중하며, 코드를 처음 다루는 학생도 따라올 수 있도록 예시 → 반복 → 문제 해결 순서로 구성되어 있습니다.
...
- **도구**: Replit (브라우저에서 바로 HTML/JavaScript 작성 — 설치 불필요)
- **수업 시간**: 주 1회, 약 40~50분
- **숙제 제출**: 결과 **영상 또는 코드 사진**을 **카카오톡**으로 보내주세요.

각 워크시트는 학생이 직접 푸는 영어 연습지입니다. 예측하기(Predict) → 버그 찾기(Spot the Bug) → 직접 만들기(Build) → 설명 영상(Walkthrough) 순서로 한 주의 개념을 충분히 반복 연습하도록 구성되어 있습니다.

---

## 📩 자세한 안내

매주 카카오톡으로 보내드린 **노션 숙제 페이지**에서 데모 영상과 숙제 안내(학습 목표·해야 할 것·성공 기준)를 확인하실 수 있습니다.
...
skill_path id: **(아직 앱에 없음)** — 이 코스는 현재 앱에 매핑되어 있지 않습니다.
