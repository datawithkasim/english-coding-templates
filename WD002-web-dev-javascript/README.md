...
**영어코딩**의 웹 개발 코스입니다. 정적인 HTML 페이지에서 출발해 버튼·입력·조건·배열을 거쳐, 마지막에는 자기만의 **대화형 퀴즈 앱**을 직접 완성합니다. 매주 한 가지 핵심 개념에 집중하며, 코드를 처음 다루는 학생도 따라올 수 있도록 예시 → 반복 → 문제 해결 순서로 구성되어 있습니다.
