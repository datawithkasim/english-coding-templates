...
**Does each step climb the same amount, or more each time? Say why.**
...
**Write the four values of `gap`. Do the blocks get further apart or closer together?**
...
**What shape do you get instead? Why does your fix work?**

<div class="write-space"></div>

**Bug B** — The first step should climb 1, then 2, then 3, then 4.
...
**Bug C** — The first step should climb **1**, not 2.
...
**Why does the order of those two lines matter?**
