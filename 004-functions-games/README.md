...
- 🗂️ **전체 파일 저장소**: [GitHub 코스 폴더](https://github.com/datawithkasim/english-coding-templates/tree/master/004-functions-games) — 월드·워크시트·코드 전부 여기 있습니다
...
이 코스를 마치면 [005 — 테마파크 크리에이터](../005-theme-park-creator) 로 이어집니다.
