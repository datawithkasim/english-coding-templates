# 🐉 3D Coordinates · Recreate the Ender Dragon (x, y, z) — English Worksheet (Beginner)
...
This should make a **long body** along z, from (0, 4, 0) to (0, 4, 5). But it stays one block.

```
fill black from (0, 4, 0) to (0, 4, 0)
```

**Fix it. Fill the blank so the body goes to z = 5.**
