...
**Topic:** FPS, Title, and a Colour-Cycling Background · **Course:** Pygame Turret · **Time:** about 45 minutes

This week you make last week's window feel **alive**. You add a **clock** to control the frame rate (FPS), give the title bar a nicer name, and make the background colour slowly change over time.
...
**Red is climbing and blue is falling, while green stays still. Describe how the background colour changes as time passes.**
...
pygame.display.set_caption("⚙️ My Turret Game v2 — 60 FPS")
...
**Watch for 10 seconds. What does the background do?**
...
**Bug B** — The background should cycle colours, but the program crashes with an error about a colour value being too big.
...
Right now red rises and blue falls. Change the formulas so the colours change in your own way. For example, make the screen slowly get darker, or make green move too.
...
### 🎯 Tune your own living background
...
When it works, send a **photo or video** of your moving background, then explain what you did. Use these sentence starters — write 4 to 6 sentences total.

> First, I added a clock so the loop …
>
> I set the FPS to … because …
>
> My colour formula makes the screen …
>
...
Take a video while your background cycles. Talk through it like you are teaching someone. Try to use these words: **clock**, **FPS**, **frame**, **tick**, **modulo**.
