...
HTML, CSS, JavaScript를 함께 사용해 **자신을 소개하는 포트폴리오 웹사이트**를 기획부터 공개까지 직접 만들어 봅니다. 매주 한 가지 섹션이나 기능을 완성하며, 이전 주차 결과물 위에 차곡차곡 쌓아 올립니다.

> 이 코스는 **영어코딩** Web Dev CSS · Web Dev JavaScript 수업을 마친 학생에게 적합합니다. 매 주 한 가지 핵심 개념에 집중합니다.
...
> ✨ 확장 워크시트는 정규 레슨에 추가로 풀 수 있는 보너스 과제입니다. 코딩이 전혀 없는 기획·디자인 과제라 1주차를 마친 뒤 아무 때나 사용할 수 있습니다.

---

## 📂 자료 사용법

워크시트는 학생용 영어 연습지입니다. 각 주차 워크시트는 그 주의 슬라이드에서 배운 개념을 **예측 → 버그 찾기 → 직접 만들기 → 발표 영상**의 순서로 연습하도록 구성되어 있습니다.

- 📝 [`worksheets/`](./worksheets) — 매주 영어 워크시트 (학생용)

이 코스는 코드를 작성하는 도구로 **Replit** 또는 웹 에디터를 사용합니다. 별도의 월드·블록 파일은 없습니다.

---

## 📩 자세한 안내

매주 카카오톡으로 보내드린 **노션 숙제 페이지**에서 데모 자료와 숙제 안내, 제출 방법을 확인하실 수 있습니다.
