# 🤖 AI001 — AI 코딩 with Replit Agent

8주 동안 코드를 직접 타이핑하는 대신 **AI(Replit Agent)에게 말로 시켜서** 자기만의 웹 앱을 만듭니다. 매주 한 가지 "프롬프트 원칙"에 집중하며, 마지막에는 처음부터 끝까지 학생 스스로 설계한 앱을 완성해 발표합니다.
...
- 📝 [`worksheets/`](./worksheets) — 매주 학생용 영어 워크시트. 프롬프트 연습 문제가 가득 들어 있습니다.
- 슬라이드는 매주 약 10분짜리 수업 자료입니다 (위 표의 링크).

숙제 안내(학습 목표, 해야 할 것, 성공 기준)와 데모는 매주 **노션 숙제 페이지**에서도 확인하실 수 있습니다. 페이지 링크는 카카오톡으로 안내드립니다.

---

## 📩 제출 방법

모든 숙제는 **카카오톡**으로 선생님께 제출합니다. 보통 완성된 화면 **사진** 또는 **영상**, 그리고 학생이 사용한 **프롬프트 텍스트**를 함께 보냅니다.
